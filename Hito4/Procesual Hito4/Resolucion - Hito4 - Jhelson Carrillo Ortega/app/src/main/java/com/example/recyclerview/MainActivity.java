...
public class MainActivity extends AppCompatActivity
{
    ...
    private final String imUR="V4OgA4O,yB3d2qH,9jMbaX2,rYndmdq,sypYnSP,HBeK1ot,YCqbt8r,eLk31XX," +
            "4ZHp7FO,XzffKgy,DJabk5C";
    private final String imName="Playlist 1,Playlist 2,Playlist 3,Playlist 4,Playlist 5,Playlist 6," +
            "Playlist 7,Playlist 8,Playlist 9,Playlist 10,Playlist 11";
    @Override
