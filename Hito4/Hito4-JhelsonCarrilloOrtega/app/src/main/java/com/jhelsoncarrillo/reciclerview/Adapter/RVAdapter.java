...
import com.jhelsoncarrillo.reciclerview.Apps.Playlist;
...
public class RVAdapter extends RecyclerView.Adapter<ViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position)
    {
        ...
        holder.getBtnesc().setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                Intent iniciar = new Intent(context, Playlist.class);
