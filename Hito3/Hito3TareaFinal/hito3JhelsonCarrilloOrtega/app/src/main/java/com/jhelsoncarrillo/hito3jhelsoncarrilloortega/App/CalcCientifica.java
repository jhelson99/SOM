...
public class CalcCientifica extends AppCompatActivity implements View.OnClickListener
{
    ...
    public Button btnporcentaje,btnfrac,btnpunto,btnc2,btnsuma,btnresta,btnmulti,btndiv,btnigual,btnexp,btnc,btnmasmenos,btnelimi,btnr;
    ...
    private void initializeComponents()
    {
        ...
        btnexp=findViewById(R.id.btexp);
        btnporcentaje = findViewById(R.id.btporcentaje);
        btnmasmenos = findViewById(R.id.btsigno);
        btnfrac = findViewById(R.id.btfraccion);
        btnpunto = findViewById(R.id.btpunto);
        btnelimi = findViewById(R.id.btborraruno);
        btnr=findViewById(R.id.btR);
        btnc = findViewById(R.id.btborrar);
        btnc2 = findViewById(R.id.btC2);
